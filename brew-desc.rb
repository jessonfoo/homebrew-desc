...
descriptions = {
  ...
  "ccm" => "Easily create and destroy an Apache Cassandra cluster on localhost",
  ...
  "itsol" => "Iterative solvers library for sparse linear systems of equations",
  ...
  "known_hosts" => "Simple cli known hosts manager",
  ...
  "libb2" => "Fast securing hashing function",
  ...
  "lz4" => "Very fast lossless compression algorithm",
  ...
  "sedna" => "XML database",
  "seexpr" => "Simple embeddable expression evaluation engine",
  ...
  "sfml" => "Simple and fast multi-media library",
  ...
  "sword" => "Cross-platform open-source tools to write Bible software more easily",
  ...
  "ume" => "MAME and MESS in a single multi-purpose emulator",
  ...
  "uru" => "Use multiple rubies more easily on multiple platforms",
