...
descriptions = {
  ...
  "jenkins-job-builder" => "Configure Jenkins jobs using YAML files stored in Git",
  ...
  "tachyon" => "Distributed storage system enabling data sharing across cluster frameworks",
