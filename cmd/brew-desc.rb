...
descriptions = {
  ...
  "avidemux" => "Multi-format video editor that cuts, filters and encodes",
  ...
  "bibclean" => "BibTeX bibliography file prettyprinter and syntax checker",
  "bibtex2html" => "BibTeX to HTML converter",
  "bibtexconv" => "BibTeX file converter",
  "bibutils" => "Bibliography conversion utilities",
  "bigdata" => "Graph database supporting RDF data model, Sesame and Bluprint APIs",
  ...
  "chruby-fish" => "Thin wrapper around chruby to make it work with the Fish sheell",
  ...
  "elixir" => "Functional meta-programming aware language built on Erlang VM",
  ...
  "gkrellm" => "Gtk-themed system monitors",
  ...
  "gupnp-tools" => "Replacements for Intel UPnP tools using GUPnP",
  ...
  "html-xml-utils" => "Utilties for manipulating HTML and XML files",
  ...
  "iptux" => "Software for sharing in LAN",
  ...
  "libvisio" => "Inpterpret and import visio diagrams",
  ...
  "renameutils" => "Five tools for file renaming",
  ...
  "sptk" => "Suite of speech signal processing tools",
  ...
  "upnp-router-control" => "Control features of router via UPnP protocol",
  ...
  "viewglob" => "File system visualization add-on for Bash or Zsh",
  ...
  "wemux" => "Enhances tmux's to provide multi-user terminal multiplexing",
  ...
  "xdu" => "Disk usage (or other tree data) display program",
