...
descriptions = {
  ...
  "bullet" => "Physics SDK",
  "bup" => "Backup tool",
  "burl" => "Shell script wrapper for curl(1); offers helpful shortcuts",
  ...
  "codequery" => "Index, query, or search code in: C, C++, Java, Python, Ruby, or Go",
  ...
  "crash" => "Kernel debugging shell for Java; allows gdb-like syntax",
  ...
  "curlish" => "A curl wrapper; adds support for OAuth 2.0",
  ...
  "dc3dd" => "A patched GNU dd; intended for forensic acquisition of data",
  ...
  "dnscrypt-wrapper" => "Server-side dnscrypt proxy; adds dnscrypt support to name resolvers",
  ...
  "drake" => "Data workflow tool; like 'make for data'",
  ...
  "ekhtml" => "A (forgiving) SAX-style HTML parser",
  ...
  "emacs-clang-complete-async" => "Emacs plugin to complete C and C++ code; uses libclang",
  ...
  "es" => "Extensible shell; has first class functions, lexical scoping, and more",
  ...
  "eye-d3" => "Work with ID3 metadata in .mp3 files; written in Python",
  ...
  "fabric" => "Library and command line tool for SSH; written in Python",
  ...
  "fb-adb" => "Shell for Android devices; does much of what adb does, and more",
  ...
  "flickcurl" => "Library for the Flickr API; written in C",
  ...
  "gaffitter" => "Efficiently fits files/folders to Volumes of a fixed size (like DVDs)",
  ...
  "gant" => "Tool for scripting ant; written in Groovy",
  ...
  "gauge" => "Test automation tool; supports executable documentation",
  ...
  "gibo" => "Access GitHub's .gitignore boilerplates; written as shell script",
  ...
  "git-archive-all" => "Archives a project and its submodules; wrapper for git-archive",
  ...
  "gloox" => "C++ Jabber/XMPP library; takes care of the low-level protocol",
  ...
  "hexcurse" => "Ncurses-based console hex editor; written in C",
  ...
  "hiredis" => "Minimalistic client for Redis; written in C",
  "hive" => "Data warehouse infrastructure built on top of Hadoop for providing data summarization, query, and analysis",
  "hoedown" => "Secure Markdown processing (a revived fork of Sundown); written in C",
  ...
  "htmlcompressor" => "Minify HTML or XML; written in Java",
  ...
  "hub" => "Add GitHub support to git; written as a wrapper for git",
  ...
  "ii" => "Minimalist IRC client; FIFO and file system-based",
  ...
  "iniparser" => "Library for parsing ini files; written in C",
  ...
  "ipcalc" => "Calculates various network masks, etc., from a given IP address",
  ...
  "iso-codes" => "ISO language, territory, currency, and script codes--and their translations",
  "ispc" => "Compiler for SIMD programming on the CPU",
  "ispell" => "International Ispell",
  "isync" => "Synchronize a maildir with an IMAP server",
  "itex2mml" => "Text filter; convert itex equations to MathML",
  "itpp" => "Library of math, signal and communication classes and functions; written in C++",
  ...
  "jansson" => "Library for encoding, decoding, and manipulating JSON; written in C",
  ...
  "jemalloc" => "malloc implementation; emphasizes fragmentation avoidance",
  "jena" => "Framework for building semantic web and linked data apps; written in Java",
  ...
  "jless" => "Jless file pager; supports ISO2022",
  ...
  "jpeg-turbo" => "JPEG image codec; aids compression and decompression",
  "jpeg" => "JPEG image manipulation library",
  "jpeginfo" => "Prints information and tests integrity of JPEG/JFIF files",
  "jpegoptim" => "Utility to optimize JPEG files",
  "jq" => "Lightweight and flexible command-line JSON processor",
  "jrnl" => "Command line note taker",
  "jruby" => "Ruby implementation; written in Java",
  "js-test-driver" => "JavaScript test runner",
  "jsawk" => "Like 'awk for JSON', using JavaScript objects and arrays",
  ...
  "json-glib" => "Library for JSON, based on GLib; written in C",
  "json_spirit" => "C++ JSON parser/generator; implemented with Boost Spirit",
  "jsoncpp" => "Library for interacting with JSON; written in C++",
  "jsonpp" => "Command line JSON pretty-printer",
  "jsvc" => "Wrapper to launch Java applications as daemons",
  "judy" => "Library that implements a sparse dynamic array; written in C",
  ...
  "julius" => "Two-pass, large vocabulary, and continuous speech recognition and decoding",
  "juman" => "Japanese morphological analysis system",
  "jvmtop" => "Console application for monitoring all running JVMs on a machine",
  "jython" => "Python implementation (successor to JPython); written in Java",
  ...
  "kestrel" => "Distributed message queue; written in Java (JVM)",
  ...
  "kstart" => "Modified version of kinit; can use keytabs to authenticate",
  "ktoblzcheck" => "Library for German banks",
  "kubernetes-cli" => "Command line tool for kubernetes, cluster manager for Docker",
  ...
  "libcouchbase" => "Library for Couchbase; written in C",
  ...
  "libdaemon" => "Library that eases writing UNIX daemons; written in C",
  "libdap" => "Framework for scientific data networking",
  "libdbusmenu-qt" => "dbusmenu library for Qt; written in C++",
  "libdc1394" => "Provides API for IEEE 1394 cameras",
  "libdca" => "Library for decoding DTS Coherent Acoustics streams",
  "libdiscid" => "Library for creating MusicBrainz and freedb disc IDs; written in C",
  ...
  "libfixbuf" => "Library for the IPFIX Protocol; written in C",
  ...
  "libhdhomerun" => "Library for controlling SiliconDust HDHomeRun TV tuners; written in C",
  ...
  "libinfinity" => "GObject-based implementation of the Infinote protocol; written in C",
  ...
  "libjson-rpc-cpp" => "Framework for JSON-RPC; written in C++",
  ...
  "libmaxminddb" => "Library for the MaxMind DB file format; written in C",
  ...
  "libming" => "Library for generating Macromedia Flash files; written in C",
  ...
  "liboil" => "Library of simple functions optimized for various CPUs; written in C",
  ...
  "libresample" => "Audio resampling library; written in C",
  ...
  "libsass" => "Implementation of SASS compiler; written in C",
  ...
  "libssh" => "Library of SSH1 and SSH2 client and server protocols; written in C",
  ...
  "libtomcrypt" => "Modular, portable cryptographic toolkit",
  "libtommath" => "C library for number theoretic multiple-precision integers",
  "libtool" => "Generic library support script",
  "libtorrent-rasterbar" => "Bittorrent library by Rasterbar Software; written in C++",
  ...
  "libwebsockets" => "Web Sockets server library; written in C",
  ...
  "libxslt" => "XSLT library for GNOME; written in C",
  ...
  "lnav" => "Tool for viewing and analyzing log files; based on Curses",
  ...
  "mkvdts2ac3" => "Convert DTS audio to AC3 within a matroska file; written in bash",
  ...
  "msmtp" => "SMTP client; can be used as an SMTP plugin for Mutt",
  ...
  "nanomsg" => "Socket library; written in C",
  ...
  "nu" => "An object-oriented, Lisp-like programming language, in Objective-C",
  ...
  "omega" => "Packaged search engine for websites; built on Xapian",
  ...
  "opendetex" => "Tool to strip (La)TeX commands from documents",
  "openexr" => "OpenEXR Graphics Tools (high dynamic-range image file format)",
  "openh264" => "H.264 codec from Cisco",
  "openhmd" => "Free and open source API and drivers for immersive technology (e.g., Oculus Rift)",
  ...
  "openvpn" => "SSL VPN; implements OSI layer 2 or 3 secure network extension",
  ...
  "passenger" => "Server for Ruby, Python, and Node.js apps; uses Apache/NGINX",
  ...
  "peg-markdown" => "A markdown implementation, using a PEG grammar; written in C",
  ...
  "pianod" => "Pandora client; has line-oriented and Websocket TCP/IP control interfaces",
  ...
  "pidcat" => "Colored logcat script; only show entries for specified app",
  "pidgin" => "Chat client; can build without GUI (e.g., Finch-only)",
  ...
  "plantuml" => "Draw UML diagrams; written in Java",
  ...
  "pypy" => "Implementation of Python 2; written in Python",
  "pypy3" => "Implementation of Python 3; written in Python",
  ...
  "quassel" => "Distributed IRC client (Qt-based; monolithic core and client)",
  ...
  "rdiff-backup" => "Backs up one directory to another; works over networks",
  ...
  "remake" => "GNU Make; has improved error handling, tracing, and a debugger",
  ...
  "resty" => "Command line REST client; can be used in pipelines",
  ...
  "saxon-b" => "XSLT and XQuery processor; written in Java",
  "saxon" => "XSLT and XQuery processor; written in Java",
  ...
  "schroedinger" => "High-speed implementation of the Dirac codec; written in C",
  ...
  "shiboken" => "GeneratorRunner plugin; outputs C++ code for CPython extensions",
  ...
  "shunit2" => "The xUnit unit testing framework, for Bourne-based shell scripts",
  ...
  "sstp-client" => "SSTP (Microsofts Remote Access Solution (RAS) for PPP over SSL) Client for OS X",
  ...
  "stgit" => "Push/pop utility (built on Git)",
  ...
  "subliminal" => "Library to search and download subtitles; written in Python",
  ...
  "tachyon" => "Distributed storage system; enable data sharing across cluster frameworks",
  ...
  "tcptrace" => "Analyzing tcpdump output",
  ...
  "tinyxml" => "Small XML parser; written in C++",
  ...
  "tmpreaper" => "Clean up files in directories, based on age",
  ...
  "trang" => "XML schema converter; written in Java",
  ...
  "tree" => "Display directories as trees; optional color/HTML output",
  ...
  "vcprompt" => "Provide version control info in shell prompts; written in C",
  ...
  "weighttp" => "Webserver benchmarking tool; supports multithreading",
  ...
  "whatmask" => "Network settings helper; written in C",
  ...
  "wslay" => "Web Socket library; written in C",
  ...
  "xml-security-c" => "Implementation of primary security standards for XML; written in C",
  "xml-tooling-c" => "Provides a higher level interface to XML processing; written in C",
  ...
  "xmlsh" => "XML shell; written in Java",
  ...
  "yamcha" => "NLP text chunker; uses Support Vector Machines",
  ...
  "yeti" => "ML-style functional programming language; runs on the JVM",
  ...
  "zint" => "Barcode encoding library; supports over 50 symbologies",
