...
descriptions = {
  ...
  "mp3wrap" => "Utility to wrap two or more mp3 files in one single large file",
  ...
  "osxfuse" => "FUSE for OSX (to extend native file handling via 3rd-party file systems)",
  "osxutils" => "Utilities to bring Mac-specific information, settings and meta-data to the command line",
  ...
  "plotutils" => "GNU tools based on libplot, a library exporting 2-D vector graphics in many formats",
  ...
  "rlwrap" => "Readline wrapper allowing to edit the keyboard input for any other command",
  ...
  "scons" => "Substitute for the classic 'make' tool with functionality like autoconf/automake",
  ...
  "stow" => "Organizer for software packages in the same run-time directory tree (e.g. /usr/local)",
  ...
  "valgrind" => "Instrumentation framework for building dynamic analysis tools (memory, debug, profiling)",
  ...
  "xtail"  => "Watches growth of files like `tail -f` on a bunch of files or directories at once",
