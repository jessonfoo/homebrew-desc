...
descriptions = {
  ...
  "awf" => "Widget factory: a theme preview application for GTK2 and GTK3",
  ...
  "baobab" => "Disk usage analyzer (via GNOME)",
  ...
  "evince" => "GNOME desktop document viewer",
  ...
  "file-roller" => "Archive manager from GNOME",
  ...
  "gjstest" => "JavaScript unit testing framework that runs on the V8 engine",
  ...
  "gnuradio" => "Development toolkit to provide the signal processing runtime",
  ...
  "libspectre" => "C library for rendering Postscript documents",
  ...
  "nifi" => "Apache system to process and distribute data",
  ...
  "nyancat" => "Nyancat for the terminal, via ANSI escape sequences",
  "nylon" => "Proxy server",
  ...
  "progress" => "Tool to show progress for cp, rm, dd, ...",
  ...
  "zmqpp" => "High-level C++ binding for 0mq/zmq",
