...
descriptions = {
  ...
  "curlish" => "A wrapper around curl to support OAuth 2.0",
  ...
  "envv" => "Shell-independent way of handling environment variables",
  ...
  "kubernetes-cli" => "Commandline tool for kubernetes, cluster manager for Docker",
  ...
  "launchdns" => "Mini DNS server designed with a single purpose of routing queries to localhost",
  ...
  "openhmd" => "Free and Open Source API and drivers for immersive technology (eg. Oculus Rift)",
  ...
  "sstp-client" => "SSTP (Microsofts Remote Access Solution (RAS) for PPP over SSL) Client for OSX",
  ...
  "vegeta" => "HTTP load testing tool and library in Go",
  ...
  "wifi-password" => "Show the password of the wifi you're on",
